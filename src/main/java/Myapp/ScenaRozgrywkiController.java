...
public class ScenaRozgrywkiController {
    ...
    public void initialize() {
        ...
        w3k0.setGraphic(pionek1down);
        w3k1.setGraphic(pionek2down);
        w3k2.setGraphic(pionek3down);
        w3k3.setGraphic(pionek4down);
        w3k4.setGraphic(pionek5down);
        w3k5.setGraphic(pionek6down);
        w3k6.setGraphic(pionek7down);
        w3k7.setGraphic(pionek8down);
        w3k8.setGraphic(pionek9down);
