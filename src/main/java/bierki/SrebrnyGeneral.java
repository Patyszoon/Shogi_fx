...
public class SrebrnyGeneral extends PromowalnaBierka{
    ...
    public SrebrnyGeneral(Board board, Kolor kolor, Stan stanb, int wiersz, int kolumna) {
        ...
        this.sprite = bierki.getSubimage(5 * rozmiarSprite, 0, rozmiarSprite, rozmiarSprite).getScaledInstance(board.rozmiarKomorki, board.rozmiarKomorki, Image.SCALE_SMOOTH);
    }
